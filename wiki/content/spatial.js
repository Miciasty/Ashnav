...
public final class AshnavFrameExample {
  ...
  window.WIKI_PAGES.push(
    ...
    },
    {
      ...
      sections:[
        {id:'attached-grid',title:'Place a corridor on a vehicle',html:`<p>This vehicle frame has no rotation and is translated by (10, 0, 20) world units. Its grid has three unit cells along local X. Node 0 is centered at local (0.5, 0.5, 0.5), which becomes world (10.5, 0.5, 20.5).</p><div data-diagram="frame-capture"></div>${code(frameExample,'java','AshnavFrameExample.java')}${code('cost=2.0, centerX=10.5','output','Expected output')}`},
