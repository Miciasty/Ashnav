...
window.WIKI_DOCS = (() => {
  ...
  return {
    ...
    note: (title, html) => `<aside class="callout my-[22px] flex items-start gap-[13px] rounded-md border border-accent/25 bg-accent-soft px-[18px] py-[15px]"><div><strong>${title}</strong>${html}</div></aside>`,
