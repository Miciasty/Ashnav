(function () {
  ...
  const figure = (title, svg, caption) => `<figure class="my-[22px] rounded-[7px] border border-line bg-surface p-[17px]"><svg viewBox="0 0 480 250" role="img" aria-label="${title}" style="display:block;width:100%;height:auto;color:var(--foreground);font:18px system-ui,sans-serif">${svg.replaceAll('<rect ', '<rect fill="var(--surface)" ')}</svg><figcaption>${caption}</figcaption></figure>`;
  ...
  window.WIKI_PAGES.push(
    {
      ...
      sections: [
        { id: 'directed-connectivity', title: 'Represent permitted moves', html:
          ...
          figure('Directed graph: node 0 leads to 1, which leads to 2. There are no reverse edges.',
            '<defs><marker id="graph-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto"><path d="M0 0 L10 5 L0 10Z" fill="currentColor"/></marker></defs><g fill="none" stroke="currentColor" stroke-width="2"><path d="M107 100H206M277 100H376" marker-end="url(#graph-arrow)"/><circle cx="70" cy="100" r="34"/><circle cx="240" cy="100" r="34"/><circle cx="410" cy="100" r="34"/></g><g fill="currentColor" text-anchor="middle"><text x="70" y="107">0</text><text x="240" y="107">1</text><text x="410" y="107">2</text><text x="240" y="177">0 → 2: [0, 1, 2]</text><text x="240" y="215">2 → 0: UNREACHABLE</text></g>',
            'The arrows are directed edges. Node 2 has an empty outgoing row, so it cannot return to node 0.') +
    ...
    },
    {
      ...
      sections: [
        { id: 'solver-objective', title: 'Fewest edges or lowest cost', html:
          ...
          figure('Weighted triangle: S to G costs 10, S to A costs 1, A to G costs 1.',
            '<defs><marker id="solver-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto"><path d="M0 0L10 5L0 10Z" fill="currentColor"/></marker></defs><g fill="none" stroke="currentColor" stroke-width="2"><path d="M90 182H390M80 164L215 66M265 66L400 164" marker-end="url(#solver-arrow)"/><circle cx="57" cy="188" r="30"/><circle cx="240" cy="48" r="30"/><circle cx="423" cy="188" r="30"/></g><g fill="currentColor" text-anchor="middle"><text x="57" y="195">S</text><text x="240" y="55">A</text><text x="423" y="195">G</text><text x="126" y="103">1</text><text x="354" y="103">1</text><text x="240" y="170">10</text><text x="240" y="236">BFS: 1 edge · Dijkstra: cost 2</text></g>',
            'The figure uses caller-defined cost units. BFS reports totalCost=1 for the direct edge even though that edge has supplied cost 10.') +
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'directed-restrictions', title: 'Add one-way movement and a cell penalty', html:
          ...
          figure('XZ slice: direct route enters a cost-5 cell; the four-edge detour costs 4.',
            '<g fill="none" stroke="currentColor" stroke-width="2"><path d="M80 78H400" stroke-dasharray="6 5"/><path d="M80 78V182H400V78" stroke-width="3"/><rect x="55" y="53" width="50" height="50" rx="5"/><rect x="215" y="53" width="50" height="50" rx="5"/><rect x="375" y="53" width="50" height="50" rx="5"/><rect x="55" y="157" width="50" height="50" rx="5"/><rect x="215" y="157" width="50" height="50" rx="5"/><rect x="375" y="157" width="50" height="50" rx="5"/></g><g fill="currentColor" text-anchor="middle"><text x="80" y="85">0</text><text x="240" y="85">1</text><text x="400" y="85">2</text><text x="80" y="189">3</text><text x="240" y="189">4</text><text x="400" y="189">5</text><text x="240" y="27">Z=0 · dashed route costs 5+1</text><text x="240" y="139">X increases →</text><text x="240" y="240">Z=1 · solid detour costs 1+1+1+1</text></g>',
            'A fixed 2D XZ slice at Y=0. Numbers inside cells are node IDs, not costs. Both Z directions are allowed; decreasing X is forbidden.')
        },
        ...
        { id: 'policy-lifetime', title: 'Keep policy inputs stable', html:
          ...
          '<p>A policy can remove only existing edges and replace their costs. It does not create edges, renumber nodes, or infer clearance. For diagonal movement, your acceptance rule can inspect side cells, headroom, support, or other character requirements through your own data. See <a href="#/minecraft-integration">Minecraft integration</a>.</p>' +
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'diagonal-clearance', title: 'A route crosses blocked side cells', html:
          ...
          '<p>Use N6 to remove diagonal edges, or supply a directed acceptance policy that checks your character’s full movement requirements. N6 alone still does not establish Minecraft walking, jumping, or falling rules. See <a href="#/grid-graphs">Grid graphs</a> and <a href="#/minecraft-integration">Minecraft integration</a>.</p>'
        },
